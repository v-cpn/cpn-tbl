(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cpn-tbl"] = factory();
	else
		root["cpn-tbl"] = factory();
...
/* harmony default export */ var header = ({
  ...
  watch: {
    column: {
      handler: function handler() {
        ...
        var toBeRender = [];
        var deepestCol = []; // adapt to element ui nested <el-table-column />

        var traverse = function traverse(vnodes, level) {
          var fullColspan = 0;
  ...
  render: function render() {
    ...
    var maxLevel = this.maxLevel,
        toBeRender = this.toBeRender;
    return h("thead", [toBeRender.map(function (row, level) {
...
// CONCATENATED MODULE: ./src/TBL/Tbl.js



/* harmony default export */ var Tbl = ({
  name: 'Tbl',
  components: {
    TblHeader: header
  },
  ...
  render: function render(h) {
    var data = this.data,
        ...
        border = this.border;
    var summaryRow = column.map(function () {
      return undefined;
    });

    if (summaryMethod) {
      // console.log('summary', column)
      var summary = summaryMethod({
        columns: column,
        data: data
      });
    ...
    var tbody = data.map(function (row, rowIndex) {
      return h("tr", {
        "key": row.key
      }, [column.map(function (col, columnIndex) {
        var rowspan = 1;
        var colspan = 1;

        if (spanMethod) {
          var spanData = spanMethod({
            row: row,
            column: col,
            rowIndex: rowIndex,
        ...
        if (showSummary && !summaryMethod && columnIndex !== 0) {
          if (!isNaN(Number(row[col.property]))) {
            if (summaryRow[columnIndex]) summaryRow[columnIndex] += Number(row[col.property]);else summaryRow[columnIndex] = Number(row[col.property]);
          }
        }
    ...
    }), h("tbody", [data.length === 0 ? h("tr", [h("td", {
      "class": "no-data",
      "attrs": {
        "colspan": column.length
      }
    }, ["\u6682\u65E0\u6570\u636E"])]) : tbody]), showSummary && data && data.length ? h("tfoot", [h("tr", [summaryRow.map(function (item) {
      return h("td", [item]);
    })])]) : null])]);
  }
});
// CONCATENATED MODULE: ./src/TBL/TblCol.js
/* harmony default export */ var TblCol = ({
  props: {
    prop: String,
    label: String,
    width: String
  ...
  render: function render(h) {
    ...
    var slot = this.$slots.default || this.$scopedSlots.default || label;
    return h('col', typeof slot === 'function' ? slot({
      row: {}
    }) : slot);
  }
});
// EXTERNAL MODULE: ./src/TBL/tbl.css
var tbl = __webpack_require__("1416");

// CONCATENATED MODULE: ./src/TBL/index.js
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (TBL);
...
//# sourceMappingURL=cpn-tbl.umd.js.map